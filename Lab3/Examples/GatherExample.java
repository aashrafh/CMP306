...
public class GatherExample {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        if(rank==root){
	    	...
	    	// Again:: 2 integer is received from each process, and 2 integer is sent to itself
        ...
        //Although it is not needed, it needs to match the total number of received messages
